...
export function ConversationKnowledgeResizeHandle({
  ...
  return (
    <div
      ...
      className={`absolute -left-1.5 top-0 z-20 hidden h-full w-3 cursor-col-resize items-stretch justify-center @min-[720px]/conversation-knowledge:flex ${isResizing ? 'bg-ring/10' : ''}`}
